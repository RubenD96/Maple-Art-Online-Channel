...
object PacketProcessor {
    ...
    init {
        ...
        handlers[RecvOpcode.MINI_ROOM] = MiniRoomHandler()
        ...
        handlers[RecvOpcode.LOG] = LogHandler()
        ...
        handlers[RecvOpcode.USER_DRAGON_BALL_SUMMON_REQUEST] = UserDragonBallSummonRequestHandler()
